...
public class Languages {
	    ...
	    @NotNull
	    @Min(value=3 , message = "Version must be greater than 3")
	    @Max(value=20 , message = "Version must be less than 20")
		...
		public Languages( String name,String creato, Double version
